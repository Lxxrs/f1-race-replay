            ...
            self.create_category_section(
                ...
                [
                    (
                        ...
                        "Launch an example insight window",
                        self.launch_example_window,
                    ),
                ],
            )
        )
            ...
            self.create_category_section(
                ...
                [
                    (
                        ...
                        self.launch_telemetry_viewer,
                    ),
                    (
                        "Driver Live Telemetry",
                        "Speed, gear, throttle & braking for a selected driver",
                        self.launch_driver_telemetry,
                    ),
                    (
                        "Live Tyre Strategy",
                        "Live tyre stints and pit stop timeline per driver",
                        self.launch_tyre_strategy,
                    ),
                ],
            )
        )
        ...
        content_layout.addWidget(
            self.create_category_section(
                ...
                [
                    (
                        "Track Position Map",
                        "Live driver positions on real or circular track map",
                        self.launch_track_position,
                    ),
                ],
            )
        )
        ...
        content_layout.addWidget(
            self.create_category_section(
                ...
                [
                    (
                        "Race Control Feed",
                        "Live FIA flags, penalties, safety car and DRS status",
                        self.launch_race_control_feed,
                    ),
                ],
            )
        )
